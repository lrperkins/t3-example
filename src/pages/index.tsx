    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c]">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          <h1 className="text-5xl font-extrabold tracking-tight text-[#6aec92] sm:text-[5rem] text-center ">
            Stackosaurus
          </h1>
          <p className="text-2xl font-medium tracking-tight text-white sm:text-[2rem] text-center -mt-8">
            Fork of Create T3 App
          </p>
